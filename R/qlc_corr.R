qlc_corr <- function(pars, datM, n) {
  ...
  plt <- ggplot(data = datMCC) +
         ...
         scale_x_log10(labels = plain, limits = c(0.01, 2.00)) +
         scale_y_log10(labels = plain, limits = c(0.01, 2.00)) + theme_bw()
  ...
  plt <- ggplot(data = datMCC) +
         ...
         scale_x_log10(labels = plain, limits = c(0.05, 0.5)) +
         scale_y_log10(labels = plain, limits = c(0.05, 0.5)) + theme_bw()
         # scale_y_continuous(labels = plain) + theme_bw()
