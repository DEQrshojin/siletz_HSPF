...
calib_wq <- function(pars, stns, strD, endD, n) {
  ...
  # NOT FINISHED--LEFT HERE ____________________________________________________

  # LOAD WQ OBS DATA & Model flows/loads/conc ----
  rchQLC <- readRDS(paste0('C:/siletz_tmdl/02_outputs/01_hspf/base_rchQLC_',
                           pars,'.RData'))
  # rchQLC <- readRDS("C:/siletz_tmdl/02_outputs/01_hspf/base_rchQLC_NOx.RData")

  qRO <- runoff_components(strD = strD, endD = endD,
                           wqDir = 'C:/siletz_tmdl/02_outputs/01_hspf',
                           emcFil = paste0('C:/siletz_tmdl/03_models/01_hspf/',
                                           'archive/base/emcdwc_', pars, '.csv'))

  # NOT FINISHED--LEFT HERE ____________________________________________________

  wqDt <- read.csv(paste0('C:/siletz_tmdl/02_outputs/01_hspf/', pars, '_', stns, '.csv'),
  ...
  ggsave(paste0(pars, '_loads_ts_', n, '.png'), plot = pltL, width = 10,
         height = 6.5,  path = 'C:/siletz_tmdl/02_outputs/01_hspf/calib/plots',
         units = 'in', dpi = 300)
...
qlc_corr <- function(pars, datM, n) {
  ...
  ggsave(paste0(pars, '_flow_v_load_', n, '.png'), plot = plt, width = 5,
         height = 3.25, path = 'C:/siletz_tmdl/02_outputs/01_hspf/calib/plots',
         units = 'in', dpi = 300)
...
check_2017_wq <- function(par, n) {
  ...
  wqAll <- readRDS(paste0('C:/siletz_misc/from_tmdl_drive/001_data/wq_data',
                          '/awqms_WQ_data.Rdata'))
  ...
  wqLC <- read.csv(paste0('C:/siletz_misc/from_tmdl_drive/001_data/wq_data',
  ...
  mdDt <- readRDS(paste0('C:/siletz_tmdl/02_outputs/01_hspf/base_rchQLC_',
                         par, '.RData'))
  ...
  ggsave(paste0(par, '_2017_conc_ts_', n, '.png'), plot = plt, dpi = 300, units = "in",
         path = 'C:/siletz_tmdl/02_outputs/01_hspf/calib/plots', width = 10, height = 7.5)
