...
qSlz <- readLines(paste0(path, 'USGS_Sta5500_Sil_InstQ_20041001_20180401.txt'))
...
names(qSlz) <- names(qSun) <- c('Date', 'Qcfs')
...
ts <- as.Date(c('2004-10-01', '2017-09-30'), '%Y-%m-%d')
...
write.csv(qData, file = 'c:/siletz/calib/gge.csv', row.names = FALSE)
